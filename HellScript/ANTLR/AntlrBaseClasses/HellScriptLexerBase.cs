...
/// </summary>
public abstract class HellScriptLexerBase : Lexer
{
    /// <summary>
    ...
    public HellScriptLexerBase(ICharStream input)
        : base(input)
    {
    }

    public HellScriptLexerBase(ICharStream input, TextWriter output, TextWriter errorOutput) : this(input)
    {
    }
