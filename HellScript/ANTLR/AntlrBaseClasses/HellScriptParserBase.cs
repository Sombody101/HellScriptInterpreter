...
using System.IO;
using static HellScriptParser;

/// <summary>
/// All parser methods that used in grammar (p, prev, notLineTerminator, etc.)
/// should start with lower case char similar to parser rules.
/// </summary>
public abstract class HellScriptParserBase : Parser
{
    private readonly Stack<string> _tagNames = new Stack<string>();
    public HellScriptParserBase(ITokenStream input)
        : base(input)
    {
    }

    public HellScriptParserBase(ITokenStream input, TextWriter output, TextWriter errorOutput) : this(input)
    {
    }
